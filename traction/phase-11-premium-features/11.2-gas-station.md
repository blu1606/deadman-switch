...
> **Priority:** 🔴 **MUST HAVE** for Hackathon.
...
2.  **Claiming (Frontend):**
    ...
    *   **UI:** "⚡ This is a Premium Vault. Gas fees are on us."
...
## 🛠️ Implementation Specs (Ready to Code)
-   [ ] **Contract:** Add `gas_tank` update instructions.
-   [ ] **API:** `pages/api/relay.ts` using `@solana/web3.js` Keypair.
-   [x] **Frontend:** Premium Gas Pre-paid Badge ✅ (Visual Only for Hackathon)
